...
<?php
	...
	try{
		 ...
		 $date =$dbh->prepare("select * from contents where category ='Devotions' and status='1' order by id desc limit 1");
		 $date->execute();
...
<head>
		<meta charset="utf-8">
		<title>Events | Dawn Wills Ministries International</title>
								...
								<div class="block clearfix">
									...
									<nav>
										<ul class="nav nav-pills nav-stacked">
											...
											<li class="active"><a href="devotions">Devotions</a></li>
