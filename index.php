...
<head>
		<meta charset="utf-8">
		<title>JIVASEN GROUP LTD</title>
		<meta name="description" content="JIVASEN GROUP">
		<meta name="author" content="JIVASEN GROUP">
							...
							<div class="col-xs-3 col-sm-6 col-md-9">
								...
								<div class="header-top-first clearfix">
									...
									<ul class="list-inline hidden-sm hidden-xs">
										<li><i class="fa fa-map-marker pr-5"></i>Plot No.293, Taban Way Bunga, Kawuku Road,P.O Box 70405</li>
										<li><i class="fa fa-phone pr-5 pl-10"></i>+256-791-808400</li>
										<li><i class="fa fa-envelope-o pr-5 pl-10"></i> info@jivasengroup.com</li>
									</ul>
								</div>
							...
							<div class="col-md-3">
								...
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href=""><img id="logo_img" src="images/logo_site.png"></a>
									</div>
										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<ul class="nav navbar-nav navbar-right">
													...
													<li class="dropdown ">
														<a href="" class="dropdown-toggle" data-toggle="dropdown">Jivasen Services</a>
														<ul class="dropdown-menu">
															<li ><a href="engineering-services.php">ENGINEERING DESIGN</a></li>
															<li ><a href="construction_service.php">JIVASEN CONSTRUCTION</a></li>
															<li ><a href="innovation_service.php">JIVASEN INNOVATION SOLUTIONS</a></li>		
														</ul>
													</li>
													<li>
					...
					<div class="slider-banner-container">
						<div class="slider-banner-fullwidth-big-height">
							<ul class="slides">
								...
								<!-- main image -->
								<img src="images/slider_image_one.png" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
								
								<!-- LAYER NR. 1 -->
								<div class="tp-caption sfb fadeout dark-translucent-bg caption-box text-left"
									style="background-color: #37176E;"
									data-x="left"
									data-y="center" 
									data-speed="500"
									data-start="1300"
								...
								<!-- main image -->
								<img src="images/image_slider_two.png" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
								...
								<!-- main image -->
								<img src="images/image_slider_three.jpg" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
						...
						<div class="col-sm-4">
							<div class="image-box style-2 mb-20">
								<div class="overlay-container overlay-visible">
									<img src="images/service_one.jpg" alt="">
									<a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
									<div class="overlay-bottom">
										<div class="text">
											<p class="lead margin-clear text-left mobile-visible">Jivasen Engineering</p>
										</div>
									</div>
								</div>
								<div class="body padding-horizontal-clear">
									<p>Jivasen Group is the name behind a number of Project Management, Engineering Design, Construction and Real-estate Development Projects / other technical assignments by..</p>
									<a class="link-dark" href="engineering-services.php">Read More</a>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="image-box style-2 mb-20">
								<div class="overlay-container overlay-visible">
									<img src="images/service_three.jpg" alt="">
									<a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
									<div class="overlay-bottom">
										<div class="text">
											<p class="lead margin-clear text-left mobile-visible">Jivasen Construction</p>
										</div>
									</div>
								</div>
								<div class="body padding-horizontal-clear">
									<p>As a General Contractor, our services begin with pricing. We bid out the job in predetermined packages,.</p>
									<a class="link-dark" href="construction_service.php">Read More</a>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="image-box style-2 mb-20">
								<div class="overlay-container overlay-visible">
									<img src="images/service_five.jpg" alt="">
									<a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
									<div class="overlay-bottom">
										<div class="text">
											<p class="lead margin-clear text-left mobile-visible">Jivasen Innovation Solutions</p>
										</div>
									</div>
								</div>
								<div class="body padding-horizontal-clear">
									<p>Jivasen Group's in-house innovation business is in doing research on various innovations solutions and would wish in the future to partner with international experts in research work..</p>
									<a class="link-dark" href="innovation_service.php">Read More</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 padding-bottom-clear pv-30">
							<div class="feature-box-2 object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
								...
								<div class="body">
									...
									<p>Our design team works with the owner and other consultants in the early phase of design, to provide..</p>
						...
						<div class="col-md-4 padding-bottom-clear pv-30 dark-translucent-bg">
							<div class="feature-box-2 object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="150">
								...
								<div class="body">
									<h4 class="title">Jivasen Construction</h4>
									<p>As a General Contractor, our services begin with pricing. We bid out the job in predetermined packages, and verify the validity of the bids using our extensive cost experienc e.</p>
									<a class="link-dark" href="construction_service.php">Read More<i class="pl-5 fa fa-angle-double-right"></i></a>
								</div>
							</div>
						</div>
						<div class="col-md-4 padding-bottom-clear pv-30">
							<div class="feature-box-2 object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
								...
								<div class="body">
									<h4 class="title">Jivasen Innovation Solutions</h4>
									<p>Jivasen Group's in-house innovation business is in doing research on various innovations solutions and would</p>
									<a class="link-dark" href="innovation_service.php">Read More<i class="pl-5 fa fa-angle-double-right"></i></a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="footer-content">
										<div class="logo-footer"><img id="logo-footer" src="images/logo_site.png" alt=""></div>
										...
										<ul class="list-inline mb-20">
											<li><i class="text-default fa fa-map-marker pr-5"></i>Plot No.293, Taban Way Bunga, Kawuku Road</li>
											<li><i class="text-default fa fa-phone pl-10 pr-5"></i>+256-791-808400</li>
											<li><a href="m" class="link-dark"><i class="text-default fa fa-envelope-o pl-10 pr-5"></i> info@theproject.com</a></li>
										</ul>
				...
				<div class="subfooter">
					<div class="container">
						<div class="subfooter-inner">
							<div class="row">
								<div class="col-md-12">
									<p class="text-center">Copyright © 2017 <a target="" href="">Jivasen Group Ltd</a>. All Rights Reserved</p>
								</div>
							</div>
						</div>
					</div>
