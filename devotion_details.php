	...
	<body class="no-trans   ">
		...
		<div class="page-wrapper">
							...
							<div class="col-md-3">
								...
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href=""><img id="logo_img" src="<?php echo BASE_URL;?>/images/logo_gold.png" alt="The Project"></a>
									</div>
										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<ul class="nav navbar-nav navbar-right">
													...
													<li>
														<a href="<?php echo BASE_URL;?>/devotions">Devotions</a>
													</li>
													<li>
														<a href="<?php echo BASE_URL;?>/events">Events</a>	
													</li>
													<li>
														<a href="<?php echo BASE_URL;?>/contactus">Gallery</a>	
													</li>
													<li>
			...
			<div class="breadcrumb-container">
				<div class="container">
					<ol class="breadcrumb">
						<li><i class="fa fa-home pr-10"></i><a href="<?php echo BASE_URL;?>/index">Home</a></li>
