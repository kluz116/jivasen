        ...
        <section class="content">
          ...
          <div class="row">
                ...
                <div class='box-body pad'>
                    ...
                    <label>Event Image (923 X 650)</label>
                    	<input type="file" name="image" class="form-control">
                    </div>
                    <div class="form-group">
                    <label>Event Content</label>
                    	<textarea class="form-control" name="content" id="content"cols="5px" rows="6px"></textarea>
                    </div><br>
                    <div class="form-group">
                    <div class="col-lg-4">
                    	<button class="form-control btn-sm btn-info" name="addEvents">Update Events</button>
                    </div>
